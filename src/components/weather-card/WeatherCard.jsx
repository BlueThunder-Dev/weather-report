...
const WeatherCard = ({ data, history,reSearchFromHistory, deleteHistoryItem }) => {
  if (!data) return null;
      ...
      <div className={styles.topContent}>
        <div className={styles.mainStats}>
          ...
          <div className={styles.locationRow}>
            <span className={styles.boldLabel}>{name}, {sys.country}</span>
            ...
            <div key={item.id} className={styles.historyRow}>
              ...
              <div className={styles.historyRight}>
                ...
                <div className={styles.historyActions}>
                  <button className={styles.circleBtn} onClick={() => reSearchFromHistory(item)}>🔍</button>
                  <button className={styles.circleBtn} onClick={() => deleteHistoryItem(item.id)}>🗑️</button>
                </div>
              </div>
            </div>
          ))
